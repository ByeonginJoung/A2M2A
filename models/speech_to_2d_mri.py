...
class Speech2MRI2D(nn.Module):
    def __init__(self,
        ...
        #if (args.model.use_deform and args.model.use_prev_frame) and args.model.use_feature_fusion:
        if args.model.use_prev_frame:
            ...
            if getattr(args.model, 'use_feature_fusion', True):
    ...
    def forward(self, x, init_image=None):
        ...
        if init_image is not None and getattr(self.args.model, 'use_feature_fusion', True):
