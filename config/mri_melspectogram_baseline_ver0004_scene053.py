...
def get_args():
    ...
    args_edict.epoch_viz = 500
    args_edict.epoch_save = 500
    args_edict.epoch_eval = 500
    ...
    args_edict.model.in_feat = (
        128  # for mgclsp, generally 25, for raw, 534, for melspectogram, 80
    )
    ...
    args_edict.data.fps_control_ratio = (
        6.0  # strongly recommended usage for this value as int type
    )
